...
info_str = """{
  ...
  "num_waitfor": [],
  "goal_affiliation": ["a1", "a1", "a2", "a2"]
}
"""
domain_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_domain.pddl')
problem_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile4.pddl')
info_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile4.json')
compiled_domain_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_domain_compiled.pddl')
compiled_problem_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile4_compiled.pddl')

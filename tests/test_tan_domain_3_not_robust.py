...
info_str = """{
  ...
  "num_waitfor": [],
  "goal_affiliation": ["a2", "a2", "a1"]
}
"""
domain_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_domain.pddl')
problem_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile3.pddl')
info_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile3.json')
compiled_domain_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_domain_compiled.pddl')
compiled_problem_path = os.path.join(test_pddl_files_dir, 'tmp_test_tan_pfile3_compiled.pddl')
